...
const routes = [_]router.Route{
    ...
    .{ .method = .GET, .path = "/arrival.js", .handler = pages.arrivalScript },
    .{ .method = .GET, .path = "/lib.js", .handler = pages.libScript },
    .{ .method = .GET, .path = "/windows.js", .handler = pages.windowsScript },
    .{ .method = .GET, .path = "/account.js", .handler = pages.accountScript },
    .{ .method = .GET, .path = "/imgw.js", .handler = pages.imgwScript },
    .{ .method = .GET, .path = "/forecast.js", .handler = pages.forecastScript },
